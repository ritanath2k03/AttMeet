...
public class StudentEnroll extends AppCompatActivity {
    TextInputEditText Name,Id,Subject,Email,Password,Stream;
...
Stream=findViewById(R.id.Teacher_Stream);
...
//Log.d("Id",model1.getCollegeId());
                    ...
                    submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        private void CreateAccount() {
                            ...
                            progressDialog=new ProgressDialog(StudentEnroll.this);
                            ...
                            auth.createUserWithEmailAndPassword(Got_Email,Got_Password)
                                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(StudentEnroll.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        } });
                }
    ...
    private void StoreData() {
        ...
        reference1.child(University).child(CollegeId).child(Clg_Name).child("Student").child(FirebaseAuth.getInstance().getUid()).setValue(map)
    ...
    private void AddData() {
        ...
        map1.put("StudentId",Id.getText().toString().toUpperCase());
        map1.put("StudentName",Name.getText().toString().toUpperCase());
        map1.put("Studentyear",Subject.getText().toString().toUpperCase());
